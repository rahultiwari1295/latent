...
<div id="templatemo_main">
    ...
    <div class="col_w600 float_l">
    	<div class="content_box">
            <h2><span class="style36 style35 style22"><span class="style41">User</span><span class="style24"> <%=(String)application.getAttribute("uname")%></span><span class="style41">'s Profile..</span></span></h2>
            <p>&nbsp;</p>
  ...
  <div class="col_w300 float_r">
    	<h2>Sidebar Menu </h2>
      <p><a href="UserProfile.jsp"><strong>Home</strong></a></p>
