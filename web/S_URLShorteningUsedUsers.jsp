...
<title>URL Shortening Users and Post Details..</title>
...
<div id="templatemo_main">
    ...
    <div class="col_w600 float_l">
   	  <div class="content_box">
            <h2><span class="style31 style46 style30  style35 style22">URL Shortening Users and Post URL Count Details..</span></h2>
            <%@ include file="connect.jsp" %>
                <%
						...
						try 
						{
						   	String query="select distinct(username) from user_url_count"; 
            ...
            <table width="421" border="1" align="center" cellspacing="2">
              ...
              <tr>
                <td  width="168" height="25" valign="middle" style="color: #2c83b0;"><div align="center" class="style121 style141">URL Name </div></td>
                <td  width="155" valign="middle" style="color: #2c83b0;"><div align="center" class="style142">Posted URL Count </div></td>
              </tr>
              <%present="false";}
			 
			 
			 					int count=0;
								String query1="select * from user_url_count where username='"+s1+"' order by url_name ASC"; 
  ...
  <div class="col_w300 float_r">
      <h2>Sidebar Menu </h2>
      <p><a href="S_URLShorteningUsedUsers.jsp"><strong>Home</strong></a></p>
