  ...
  try{      
         		if(!comment.equals(""))
				{
						...
						String present="false";
							...
							String space=" ";
							StringBuffer bf=new StringBuffer(comment);
							bf.append(space);
						...
						int k=st1.executeUpdate (query1);
						  ...
						  if(k>0&&e>0)
						  {
								...
								String query6 ="insert into attacker (username,tname,comment,date) values ('"+uname+"','"+tname+"','"+comment+"','"+date+"')";
								st6.executeUpdate (query6);
							
								%>	
								<br/><p align="center" class="style46 style2"><strong>This Comment Contains Short terms of URLs..These are Strictly Prohibbited..</strong></p><%
						
								}%>
														
</div>
								<br/><p align="center" class="style46 style3"><strong>Tweet Submitted Successfully..</strong></p>
								<p align="center" class="style17">&nbsp;</p>
								<p align="center"><a href="SearchTweets1.jsp?tname=<%=tname%>" class="style44"><strong>Back</strong></a></p>
								<div align="center">
								<%
		...
		else
		{
					...
					<p align="center" class="style46 style1">Enter Your Tweet Comment !!..</p>
					<p align="center" class="style17">&nbsp;</p>
					<p align="center"><a href="SearchTweets1.jsp?tname=<%=tname%>" class="style44"><strong>Back</strong></a></p>
					<div align="center">
					<%
