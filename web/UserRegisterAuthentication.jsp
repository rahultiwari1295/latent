...
.style23 {font-size: 25px; color: #FF00FF;}
...
<div id="templatemo_main">
    ...
    <div class="col_w600 float_l">
    	<div class="content_box">
            <h2 class="style23">User Registration Status..</h2>
            <div>
              <label for="name">
              ...
              <p>&nbsp;</p>
              <p align="center" class="style24 style25">User Name Already Exist..</p>
              <p align="center" class="style18 style24">&nbsp;</p>
              <p align="center" class="style21"><a href="UserRegister.jsp"><strong>Back</strong></a></p>
              <p align="center">
                <%
...
PreparedStatement ps=connection.prepareStatement("insert into user(username,password,email,mobile,address,dob,gender,status,image,user_kind) values(?,?,?,?,?,?,?,?,?,?)");
              ...
              <p align="center">&nbsp;</p>
              <p align="center" class="style42 style25">Registration Successfull..</p>
              <p align="center" class="style42">&nbsp;</p>
              <p align="center"><a href="UserLogin.jsp" class="style21"><strong>Back</strong></a></p>
              <%
